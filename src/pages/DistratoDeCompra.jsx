  ...
  return (
    <div className="w-[90%] max-w-[800px] mx-auto my-5 bg-white p-4 sm:p-5 rounded shadow-md">
      ...
      <header className="text-center mb-5">
        <h1 className="text-3xl font-bold text-[#253155]">
          Distrato de Compra do Imóvel
        </h1>
        <button className="mt-4 bg-[#253155] text-white px-5 py-2 rounded transition-colors duration-300 hover:bg-[#1d2747]">
