...
Uma das novas inserções previstas por lei e que afetará e muito o bolso dos compradores, diz respeito à multa que agora poderá ser estipulada em até 50% (a depender de acordo em contrato), podendo sim ser diminuída. Sendo assim, em casos de distrato o que se busca em nome do comprador é a devolução de 80% a 100% daquilo que já foi investido, de modo que a multa seja reduzida a 20% ou menos.`,
  ...
  {
    id: 5,
    slug: "brookfield-50-mil",
    titulo:
      "Brookfield Incorporações é condenada a ressarcir quase 50 mil reais a um cliente por não cumprimento de contrato",
    excerpt:
      "A Justiça entende, baseada na jurisprudência deste tipo de caso, que o não cumprimento contratual por parte da construtora, causa danos financeiros e morais ao comprador, principalmente...",
    texto: `A Justiça entende, baseada na jurisprudência deste tipo de caso, que o não cumprimento contratual por parte da construtora, causa danos financeiros e morais ao comprador, principalmente pelo enorme valor econômico e emocional embutido na compra do imóvel.
E mesmo quando o comprador, por motivo de força maior, se vê impossibilitado de pagar as parcelas, o próprio imóvel serve de garantia para que a construtora não perca o seu investimento.

“INTIME-SE À PARTE RÉ PESSOALMENTE ( MANDADO – Oficial de Justica) PARA EFEITO DE DEPOSITAR EM JUÍZO TAL QUANTIA ( R$ 49.843,61 ) EM ATÉ TRÊS DIAS, CIENTE DE LOGO QUE O EVENTUAL DESCUMPRIMENTO DE TAL ORDEM PODERÁ ACARRETAR O PAGAMENTO DE SANÇÃO MENSAL DE VALOR EQUIVALENTE A 10% DO VALOR TOTAL ALUDIDO, QUE SERÁ APLICADA MÊS A MÊS ATÉ O EFETIVO ADIMPLEMENTO DO COMANDO.”

No processo digital de número: 0094440-19.2019.8.19.0001 você encontra mais detalhes. – TJRJ
Link: http://www4.tjrj.jus.br/ConsultaUnificada/consulta.do#tabs-numero-indice0

Proteja-se de contratos e financiamentos abusivos de construtoras.
Está se sentindo prejudicado com sua compra de imóvel e busca seus direitos?
...
Entre em contato conosco.`,
  ...
  {
    id: 6,
    slug: "mais-uma-vitoria-de-nossos-clientes",
    titulo: "Mais uma vitória de nossos clientes",
    excerpt:
      "Juiz determina penhora imediata dos valores a serem devolvidos aos compradores do imóvel no Condomínio Vila das Fontes Residencial – Vila da Penha, Rio de Janeiro – RJ...",
    texto: `Juiz determina penhora imediata dos valores a serem devolvidos aos compradores do imóvel no Condomínio Vila das Fontes Residencial – Vila da Penha, Rio de Janeiro – RJ.
 

Clientes da Accacio Monteiro Barrozo Advogados, Sr. J.T.S. e a Sra. A.M.J.T.* moveram ação contra a empresa Brookfield, hoje sucedida pelas empresas, TEGRA INCORPORADORA S.A. e TG RIO DE JANEIRO EMPREENDIMENTOS IMOBILIÁRIA S.A

Os autores do processo pagaram à construtora parcelas totalizando R$ 66.458,15 quando, protegidos pelo Código de Defesa do Consumidor, desistiram da compra do imóvel, solicitando a rescisão do contrato.

Sendo assim, moveram uma ação contra a construtora, que além de alegar que não devolveria os valores pagos, vendeu o imóvel financiado pelos compradores para outro cliente.

O juiz, determinou então, antes do final do processo, a penhora na conta da construtora do percentual de 75% do valor pago pelos compradores.

A decisão ocorreu em 28/05/19, no Tribunal de Justiça do Rio de Janeiro, sendo determinado pelo juiz o pagamento da restituição impositiva no valor de R$ 49.843,61 aos autores do processo, que alegaram não ter interesse em conciliação judicial.
...
“INTIME-SE À PARTE RÉ PESSOALMENTE ( MANDADO – Oficial de Justiça) PARA EFEITO DE DEPOSITAR EM JUÍZO TAL QUANTIA ( R$ 49.843,61 ) EM ATÉ TRÊS DIAS, CIENTE DE LOGO QUE O EVENTUAL DESCUMPRIMENTO DE TAL ORDEM PODERÁ ACARRETAR O PAGAMENTO DE SANÇÃO MENSAL DE VALOR EQUIVALENTE A 10% DO VALOR TOTAL ALUDIDO, QUE SERÁ APLICADA MÊS A MÊS ATÉ O EFETIVO ADIMPLEMENTO DO COMANDO.”

No processo digital de número: 0094440-19.2019.8.19.0001 você encontra mais detalhes.
Link para o Tribunal: http://www4.tjrj.jus.br/ConsultaUnificada/consulta.do#tabs-numero-indice0 
...
Custas na forma da Lei nº 9.289/96, ressaltando-se a gratuidade de justiça que ora defiro aos Autores. Face à sucumbência mínima dos Autores, condeno solidariamente as Rés ao pagamento de honorários advocatícios, que, com fulcro no art. 85, §2º, do CPC, ora arbitro em 10% (dez por cento) do valor da condenação.`,
  ...
  {
    id: 9,
    slug: "cef-e-condenada-pagar-r-20-000-de-danos-morais-por-anatocismo",
    titulo: "CEF é condenada a pagar R$ 20.000 de danos morais por anatocismo",
    excerpt:
    ...
    texto: `<p><strong>Nº do Processo:</strong> 2010.51.02.001648-0</p>
<br/>
    <p>Decisão foi da 4ª Vara Federal de Niterói, que após verificar os laudos periciais contábeis, identificou a prática de juros sobre juros (anatocismo) em financiamento imobiliário. Tal exercício é considerado abusivo segundo a legislação brasileira.</p>

    <p>A Caixa Econômica foi sentenciada a recalcular os valores do financiamento pelo SFH (Sistema Financeiro de Habitação) e a pagar, na figura de Danos Morais, a quantia de 20 mil reais ao mutuário que foi lesado ao longo do período de pagamento das parcelas.</p>
<br/>
    <h3><strong>Veja a decisão:</strong></h3>
<br/>

    <p>Compulsando detidamente os autos, verifico que às fls. 368/415 foi apresentado laudo pericial contábil na fase de conhecimento. Às fls. 443/448 foi prolatada sentença julgando procedente em parte o pedido do autor para condenar a CEF a recalcular o contrato de financiamento excluindo-se a prática de anatocismo, que deverá ser feito em sede de liquidação de sentença, na forma do art. 23, da Lei n. 8004/90, acrescido de juros de 0,5% ao mês, a contar da citação e correção monetária a partir do ajuizamento da presente demanda.</p>

    <p>Condeno ainda a CEF a indenizar a parte autora pelos danos morais que sofreu no valor de R$ 20.000,00 (vinte mil reais), que deverá ser corrigido monetariamente de acordo com os índices utilizados no Manual de Correção Monetária da Justiça Federal, a partir desta decisão, conforme Súmula 362, do STJ, devendo ainda incidir juros de mora de 1% ao mês (art. 406 do CC/2002) a contar do ajuizamento da ação até o efetivo pagamento.</p>

    <p>Condeno a CEF ao pagamento de honorários de sucumbência que fixo em 10% do valor da condenação.</p>

    <p>Concluso ao Magistrado(a) <em>WILLIAM DOUGLAS RESINENTE DOS SANTOS</em> em 23/01/2017.</p>
  `,
    categoria: "Artigo",
    data: "16 de julho de 2018",
    imagem: "",
